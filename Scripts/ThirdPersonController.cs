...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        [Tooltip("Sensitivity for mouse look/camera rotation")]
        ...
        private void Awake()
        {
            _tpsc = GetComponent<ThirdPersonShooterController>();
        ...
        private void Move()
        {
            ...
            float targetSpeed = ((_input.sprint && !_input.aim && !_tpsc.isHipfiring && !_tpsc.isReloading)) ? SprintSpeed : MoveSpeed;
